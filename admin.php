    ...
    <header class="d-flex flex-wrap justify-content-center">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                ...
                -->
                <a href="#" class="nav-link active custom-active" target="_self" aria-current="page">Admin Page</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                -->
                <a href="editAccount.php" class="nav-link text-black" target="_self">Edit Account</a>
            </li>
        </ul>
    </header>
